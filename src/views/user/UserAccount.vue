        ...
        <v-layout>
          <v-navigation-drawer permanent location="left">
            ...
            <v-list density="compact" nav>
              ...
              <v-list-item prepend-icon="home_account" title="Home" value="home"></v-list-item>
              <v-list-item prepend-icon="star" title="My Favorites" value="favorites"></v-list-item>
              <v-list-item @click="zumDashboard" prepend-icon="dashboard" title="Dashboard"
